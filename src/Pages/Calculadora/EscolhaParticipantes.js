    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.caixaDropdowns}>
        ...
        <ReturnSvg svg={"Adulto"}/>
          ...
          <TextInput
            ...
            value={numAdultos}
            maxLength={2}
            onBlur={() => numAdultos < 0 || numAdultos == "" ? setNumAdultos("0") : null}
          />
        </View>
        <View style={[styles.inputContainer, Fundos.fundoPrimario]}>
          ...
          <TextInput
            ...
            value={numCriancas}
            maxLength={2}
            onBlur={() => numCriancas < 0 || numCriancas == "" ? setNumCriancas("0") : null}
          />
        </View>
      </View>
      ...
      <TouchableOpacity onPress={() => navigation.pop()} style={[styles.botoesNavegacao, Fundos.fundoTerciario]}>
        ...
        <TouchableOpacity onPress={() => {
          numAdultos == "" ? setNumAdultos("0") : null;
          numCriancas == "" ? setNumCriancas("0") : null;
          (parseInt(numAdultos) + parseInt(numCriancas)) > 50 || (parseInt(numAdultos) + parseInt(numCriancas)) < 1 ? 
          Alert.alert("Número de Pessoas Inválido: Mínimo de 1 e máximo de 50.") : 
          (navigation.navigate('Carnes', {adultos: numAdultos, criancas: numCriancas}));}} style={[styles.botoesNavegacao, Fundos.fundoTerciario]}>
            <Text style={Fontes.escritaPrimaria}>
                Próximo
            </Text>
        </TouchableOpacity>
